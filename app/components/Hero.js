...
export default function Hero() {
  return (
    <section
      ...
      className="relative mt-3 mb-16 overflow-hidden pt-4 pb-8 sm:mt-6 sm:mb-20 md:pt-10 md:pb-10 lg:mb-25"
    >
      <DottedGrid className="absolute inset-0 h-full w-full opacity-55 [mask-image:linear-gradient(to_bottom,transparent,black_16%,black_72%,transparent)]" />
